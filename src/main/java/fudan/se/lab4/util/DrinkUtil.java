...
public class DrinkUtil {
    ...
    public static void isDrinkIngredientValid(Ingredient ingredient) {
        if (ingredient.getNumber()<0||!(ingredient.getName().equals("milk")&&ingredient.getName().equals("chocolate")&&ingredient.getName().equals("cream")&&ingredient.getName().equals("sugar"))){
